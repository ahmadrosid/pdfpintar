        ...
        <div class="min-h-56 w-full sm:w-[350px] px-4">
            ...
            <div>
                <button
                    ...
                    class="w-full bg-neutral-600 text-white py-2.5 px-4 rounded-lg hover:bg-neutral-700 transition-colors duration-300 mb-1 text-sm"
                ...
                <button
                    ...
                    class="w-full bg-teal-600 text-white py-2.5 px-4 rounded-lg hover:bg-teal-700 transition-colors duration-300 mt-2 text-sm flex items-center justify-center gap-2"
                    wire:loading.attr="disabled"
